  ...
  return (
    <>
      ...
      <div className="flex gap-5 justify-center w-full">
        <h1 className="lg:hidden text-3xl ml-4 font-bold text-palette-dark font-yantra">MY HUDDLES</h1>
        <div className="flex flex-col justify-center w-[150px] text-2xl border-solid border-[0.5px] border-palette-orange shadow-md rounded-lg ">
          ...
          <p className="ml-4 text-palette-black font-karla self-center">{numOfCreatedHuddles}</p>
        </div>
        <div className="flex flex-col justify-center  w-[150px] text-2xl border-solid border-[0.5px] border-palette-orange   shadow-md rounded-lg ">
