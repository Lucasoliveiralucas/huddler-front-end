...
function UserInfo({ numOfCreatedHuddles, huddlesUserIsGoing }: Props) {
  ...
  return (
    <>
      ...
      <br />
      <div className="flex gap-5 justify-center w-full px-8">
        <h1 className="lg:hidden text-3xl font-bold text-palette-dark">My Huddles</h1>
        <div className="flex flex-col justify-center w-[150px] text-2xl border-solid border-[0.5px] border-palette-orange shadow-md rounded-lg ">
          ...
          <p className="font-yantra font-medium text-palette-dark self-center">{numOfCreatedHuddles}</p>
        </div>
        <div className="flex flex-col justify-center w-[150px] text-2xl border-solid border-[0.5px] border-palette-orange   shadow-md rounded-lg ">
